...
function sinatra_is_top_bar_displayed( $post_id = 0 ) {
	...
	return apply_filters( 'sinatra_is_top_bar_displayed', $top_bar_displayed );
}
...
function sinatra_is_pre_footer_displayed( $post_id = 0 ) {
	...
	return apply_filters( 'sinatra_is_pre_footer_displayed', $displayed );
}
...
function sinatra_is_pre_footer_cta_displayed( $post_id = 0 ) {
	...
	if ( $post_id && $cta_displayed ) {
		$cta_displayed = ! get_post_meta( $post_id, 'sinatra_disable_prefooter_cta', true );
	}
	...
	return apply_filters( 'sinatra_is_pre_footer_cta_displayed', $cta_displayed );
}
...
function sinatra_is_footer_displayed( $post_id = 0 ) {
	...
	return apply_filters( 'sinatra_is_footer_displayed', $footer_displayed );
}
...
function sinatra_is_copyright_bar_displayed( $post_id = 0 ) {
	...
	return apply_filters( 'sinatra_is_copyright_displayed', $displayed );
}
...
function sinatra_is_colophon_displayed( $post_id = 0 ) {
	...
	return apply_filters( 'sinatra_is_colophon_displayed', $displayed );
}
...
function sinatra_is_page_header_displayed( $post_id = 0 ) {
	...
	return apply_filters( 'sinatra_is_page_header_displayed', $displayed );
}

				...
				<div class="sinatra-section sinatra-columns">
					...
					<div class="sinatra-column">
						<div class="sinatra-box">
							...
							<p><?php esc_html_e( 'Install the recommended plugins in 1-click. These free plugins extend and customize your website.', 'sinatra' ); ?></p>
					...
					<div class="sinatra-column hidden">
						<div class="sinatra-box">
							...
							<div class="sinatra-buttons plugins">
								...
								if ( file_exists( WP_PLUGIN_DIR . '/sinatra-core/sinatra-core.php' ) && is_plugin_inactive( 'sinatra-core/sinatra-core.php' ) ) {
									...
									$link        = '#';
									$data        = ' data-plugin="sinatra-core" data-action="install"';
								} else {
					...
					<div class="sinatra-column">
						<div class="sinatra-box">
							...
							<p><?php esc_html_e( 'Customize menu links and choose what&rsquo;s displayed in all available theme menu locations.', 'sinatra' ); ?></p>
					...
					<div class="sinatra-column">
						<div class="sinatra-box">
							...
							<p><?php esc_html_e( 'Replace the default theme colors and make your website color scheme match the brand design.', 'sinatra' ); ?></p>
		...
		public function highlight_submenu( $submenu_file ) {
			...
			if ( 'themes.php' === $pagenow ) {
				if ( isset( $_GET['page'] ) ) { // phpcs:ignore
					if ( 'sinatra-plugins' === $_GET['page'] || 'sinatra-changelog' === $_GET['page'] ) { // phpcs:ignore

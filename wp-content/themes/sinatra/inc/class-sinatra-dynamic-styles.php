...
if ( ! class_exists( 'Sinatra_Dynamic_Styles' ) ) :
	...
	class Sinatra_Dynamic_Styles {
		...
		public function get_css( $custom_css = false ) {
			...
			// Font size.
			$css .= $this->get_range_field_css( '#sinatra-header-inner', 'font-size', 'main_nav_font_size', false );
			...
			if ( sinatra_option( 'enable_pre_footer_cta' ) ) {
				...
				if ( sinatra_option( 'enable_pre_footer_cta' ) ) {
					...
					// Font size.
					$css .= $this->get_range_field_css( '#si-pre-footer .h2', 'font-size', 'pre_footer_cta_font_size', true );
				}
			}
			...
			if ( sinatra_option( 'page_header_enable' ) ) {
				...
				// Page Header.
				$css .= $this->get_range_field_css( '.si-page-header-wrapper', 'min-height', 'page_header_height', true, 'px' );
				...
				if ( isset( $page_header_color['text-color'] ) && $page_header_color['text-color'] ) {
					$css .= '
						...
						.si-single-layout-2 .page-header .entry-meta {
							color: ' . sinatra_hex2rgba( $page_header_color['text-color'], 0.75 ) . '; 
						}

						.si-single-layout-2 .page-header .entry-meta .entry-meta-elements>span:before {
							background-color: ' . sinatra_hex2rgba( $page_header_color['text-color'], 0.5 ) . '; 
						}
					';
				}
				...
				if ( isset( $page_header_color['link-color'] ) && $page_header_color['link-color'] ) {
					$css .= '
						...
						.si-single-layout-2.single .page-header .post-category a {
							color: ' . $page_header_color['link-color'] . ';
							border-color: ' . $page_header_color['link-color'] . ';
						}

						.si-single-layout-2.single .page-header .post-category a:hover {
							background-color: ' . $page_header_color['link-color'] . ';
						}
					';
				}
				...
				if ( isset( $page_header_color['link-hover-color'] ) && $page_header_color['link-hover-color'] ) {
					$css .= '
						...
						.si-single-layout-2 .page-header .entry-meta a:hover { 
		...
		public function get_block_editor_css() {
			...
			// Body.
			$css .= $this->get_typography_field_css( '#editor .editor-styles-wrapper, .editor-styles-wrapper .wp-block', 'body_font' );
			$css .= '
				.editor-styles-wrapper, .wp-block {
					color: ' . $text_color . ';
				}
			...
			if ( 'post' !== $post_type ) {
				$css .= '
					#editor .editor-post-title__block .editor-post-title__input {
						text-align: ' . sinatra_option( 'page_header_layout' ) . ';
					}
				';
			}

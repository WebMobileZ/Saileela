...
if ( ! class_exists( 'Sinatra_Customizer_Page_Header' ) ) :
	...
	class Sinatra_Customizer_Page_Header {
		...
		public function register_options( $options ) {
			...
			// Layout.
			$options['setting']['sinatra_page_header_layout'] = array(
				'transport'         => 'postMessage',
				'sanitize_callback' => 'sinatra_sanitize_select',
				'control'           => array(
					'type'     => 'sinatra-select',
					'label'    => esc_html__( 'Page Header Layout', 'sinatra' ),
					'section'  => 'sinatra_section_page_header',
					'choices'  => array(
						'left'   => esc_html__( 'Title Left / Breadcrumbs Right', 'sinatra' ),
						'center' => esc_html__( 'Centered', 'sinatra' ),
					),
					'required' => array(
						array(
							'control'  => 'sinatra_page_header_enable',
			...
			// Page Header height.
			$options['setting']['sinatra_page_header_height'] = array(
				'transport'         => 'postMessage',
				'sanitize_callback' => 'sinatra_sanitize_responsive',
				'control'           => array(
					'type'        => 'sinatra-range',
					'label'       => esc_html__( 'Min Height', 'sinatra' ),
					'description' => esc_html__( 'Choose min height for Page Header section.', 'sinatra' ),
					'section'     => 'sinatra_section_page_header',
					'min'         => 0,
					'max'         => 1200,
					'step'        => 1,

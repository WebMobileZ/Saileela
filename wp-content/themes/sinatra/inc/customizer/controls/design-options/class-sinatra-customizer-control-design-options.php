					...
					<# if ( 'background' in data.display ) { #>
						...
						<# if ( 'gradient' in data.display['background'] ) { #>
							...
							<div data-dep-field="background-type" data-dep-value="gradient">
								...
								<!-- Color 1 Location -->
								<div class="sinatra-range-wrapper popup-element color-element style-2">
								...
								<!-- Linear Angle -->
								<div data-dep-field="gradient-type" data-dep-value="linear" class="sinatra-range-wrapper popup-element color-element style-2">

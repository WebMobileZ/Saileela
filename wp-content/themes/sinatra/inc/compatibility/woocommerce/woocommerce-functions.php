...
if ( ! function_exists( 'sinatra_wc_empty_cart_button' ) ) :
	...
	function sinatra_wc_empty_cart_button() {
		...
		<p class="return-to-shop si-woo-return">
			<a class="si-btn btn-reveal btn-left-icon" href="<?php echo esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ); // phpcs:ignore ?>" role="button">
				<span><?php esc_html_e( 'Return to Shop', 'sinatra' ); ?></span>
				<i class="si-icon si-arrow-left" aria-hidden="true"></i>
			</a>
		</p>
		<?php
	}

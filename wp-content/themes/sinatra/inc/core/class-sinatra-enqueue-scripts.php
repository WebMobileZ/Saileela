...
function sinatra_enqueues() {
	...
	wp_register_script(
		'html5shiv',
		SINATRA_THEME_URI . '/assets/js/' . $sinatra_dir . 'vendor/html5' . $sinatra_suffix . '.js',
		array(),
		'3.7.3',
		true
	);
	...
	wp_register_script(
		'imagesloaded',
		SINATRA_THEME_URI . '/assets/js/' . $sinatra_dir . 'vendor/imagesloaded' . $sinatra_suffix . '.js',
		array(),
		'4.1.4',
		true
	);
	...
	wp_register_script(
		'sinatra-slider',
		SINATRA_THEME_URI . '/assets/js/' . $sinatra_dir . 'sinatra-slider' . $sinatra_suffix . '.js',
		array( 'imagesloaded' ),
		SINATRA_THEME_VERSION,
		true
	);
	...
	wp_enqueue_script(
		'sinatra-js',
		SINATRA_THEME_URI . '/assets/js/' . $sinatra_dir . 'sinatra' . $sinatra_suffix . '.js',
		array(),
		SINATRA_THEME_VERSION,
		true
	);

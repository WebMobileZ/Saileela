...
<div class="parallax">
        ...
        <div class="form">
                ...
                <div id="message">
                    ...
                    ?>
<?php if(empty($error)){  if(isset($_GET['login']) && $_GET['login'] == 'failed')
{
	?>
		  ...
		  <?php } } ?>
            ...
            <ul class="tab-group">
                <li class="tab  signup-tab"><a class="signup">Sign Up</a></li>
                <li class="tab active login-tab"><a class="login">Log In</a></li>
            </ul>
...
if (is_user_logged_in()) {               
  //  echo '<div class="logout"> <p>Hello!<div class="logout_user"> You are logged in and can proceed to the <a href="http://example.com/seminar">Online Seminar</a>.</div></p><br /><p><a id="wp-submit" class="logout" href="', wp_logout_url(), '" title="Logout">Logout</a></p></div>';
   echo  '<a href="'. wp_logout_url() .'">Log Out</a>';
		...
		<form name="loginform" id="registerform" action="<?php echo get_page_link(5) ?>"  method="post">
            ...
            <input type="submit" name="btnregister" id="wp-submitr"  value ="Register" class="button button-primary" >
				...
				<input type="hidden" name="redirect_to" value="https://localhost/sai">
			</p>
